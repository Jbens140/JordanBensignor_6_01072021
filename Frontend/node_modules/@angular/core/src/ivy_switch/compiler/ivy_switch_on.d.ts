 ...
 */
import { compileComponent, compileDirective } from '@angular/core/src/render3/jit/directive';
import { compileInjectable } from '@angular/core/src/render3/jit/injectable';
import { compileNgModule, compileNgModuleDefs, patchComponentDefWithScope } from '@angular/core/src/render3/jit/module';
